# 🔑 Secret Management Studio
> Generate secure HashiCorp Vault policies, dynamic Python secrets retrieval utilities, and Kubernetes Sealed Secrets.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/secrets/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/secrets/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-secrets.git
cd tp-secrets
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/secrets/) |
